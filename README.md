...
le jeu correspond à un Labyrinthe dans lequel :
 - Le joueur incarne un personnage dans un labyrinthe sous forme d'une ville. 
...
###3 - Exécution
 ...
 A partir du moteur de jeu Unity : 
	...
	- Il suffit de cliquer sur File, ensuite Build & Run et le jeu sera lancer.
	- Pour jouer il suffit d'utiliser les touches du clavier (Up, Down, Left et right)
